...
public class BrowserFactory {
    ...
    private static final String executionTypeProperty = System.getProperty("execution.type");
    private static final String host = System.getProperty("remote.execution.host");
    private static final String port = System.getProperty("remote.execution.port");
        ...
        // Local execution condition
            ...
            if (browserType == BrowserType.GOOGLE_CHROME
                ...
                if (System.getProperty("maximize").equalsIgnoreCase("true")) {
                    ...
                    || (browserType == BrowserType.FROM_PROPERTIES && browserTypeProperty.equalsIgnoreCase("safari"))){
